<?php
    ...
    $_SESSION['departements_number'] = count($DB_connection->query("SELECT * FROM departement WHERE Id_Admin = '{$_SESSION['Id_Admin']}'")->fetchAll(PDO::FETCH_ASSOC ));
    $_SESSION['interns_number'] = count($DB_connection->query("SELECT * FROM intern ")->fetchAll(PDO::FETCH_ASSOC ));
