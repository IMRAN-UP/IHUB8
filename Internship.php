...
$_SESSION['internships_number'] = count($DB_connection->query("SELECT * FROM internship WHERE Id_Admin = '{$_SESSION['Id_Admin']}'")->fetchAll(PDO::FETCH_ASSOC ));

$query_intern = $DB_connection->query("SELECT * FROM intern ")->fetchAll(PDO::FETCH_ASSOC);
$query_departement = $DB_connection->query("SELECT * FROM departement WHERE Id_Admin = '{$_SESSION['Id_Admin']}'")->fetchAll(PDO::FETCH_ASSOC);
...
$query_internship = $DB_connection->query("SELECT * FROM internship JOIN intern ON internship.Id_Intern = intern.Id_Intern JOIN departement ON internship.Id_Depart = departement.Id_Depart WHERE internship.Id_Admin = '{$_SESSION['Id_Admin']}'")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href=".\CSS_files\internship.css">
...
<body>
    ...
    <script src=".\JS_files\internship.js"></script>
</body>
</html>