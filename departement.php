...
$sql = $DB_connection->query("SELECT * FROM departement WHERE Id_admin = '{$_SESSION['Id_Admin']}' ORDER BY Name_Depart ASC ")->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <link rel="stylesheet" href=".\CSS_files\departement.css">
...
<body>
    ...
    <script src=".\JS_files\departement.js"></script>
</body>
</html>