...
$sql = $DB_connection->query("SELECT * FROM INTERN JOIN administrator ON INTERN.Id_Admin = administrator.Id_Admin")->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <link rel="stylesheet" href=".\CSS_files\intren.css">
...
<body>
    ...
    <script src=".\JS_files\intern.js"></script>
</body>
</html>